...
public class Startup
{
    ...
    public async Task RunBotAsync()
    {
        ...
        Client.ComponentInteractionCreated += ClientInteractionCreated.Client_InteractionCreated;
        ...
        {
            Directory.CreateDirectory(Path.Combine(Directory.GetCurrentDirectory(), "CustomCommands"));
        }
        else
        {
        ...
        foreach (CommandsNextExtension cmdNext in Commands.Values)
        {
            ...
            cmdNext.RegisterCommands<SystemCommands>();
